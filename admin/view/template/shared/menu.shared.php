        ...
        <div class="navbar-custom-menu">
            <ul class="nav navbar-nav">
                ...
                <li class="dropdown user user-menu">
                    <a href="#" class="dropdown-toggle" data-toggle="dropdown">
                        <img src="<?php echo URLAD; ?>dist/img/avatar5.png" class="user-image" alt="User Image">
                        <span class="hidden-xs"><?php echo $valor["nombre"] ?></span>
                    </a>
                    <ul class="dropdown-menu">
                        <!-- User image -->
                        <li class="user-header">
                            <img src="<?php echo URLAD; ?>dist/img/avatar5.png" class="img-circle" alt="User Image">
    ...
    <section class="sidebar">
        ...
        <ul class="sidebar-menu" data-widget="tree">
            ...
            <?php
                ...
                $active4 = ($ruta[1] == "config" && $ruta[0] == "admin") ? "active" : "" ;
            ?>
